...
namespace Broodline.Frontier
{
    ...
    public sealed class FrontierVisualDefinition
    {
        ...
        // Optional Resources GameObject asset. A prefab or imported .frontiermesh
        // can supply it; the procedural builder remains the invalid/missing fallback.
    ...
    public static class FrontierVisuals
    {
        ...
        static Dictionary<string, FrontierVisualDefinition> Index()
        {
            ...
            // Revisions invalidate cached portraits for this runtime art swap.
            Add(new FrontierVisualDefinition("vetch", FrontierKind.Companion, FrontierRigDefinition.For("vetch"), FrontierVetch.Build, new FrontierPortrait(-32, 12, .12f), 0, 1, 4));
            Add(new FrontierVisualDefinition("ember", FrontierKind.Companion, FrontierEmber.Rig, FrontierEmber.Build, new FrontierPortrait(-30, 8, .14f), 0, 1, 5));
            Add(new FrontierVisualDefinition("pale", FrontierKind.Companion, FrontierPale.Rig, FrontierPale.Build, new FrontierPortrait(-38, 14, .10f), 0, 1, 4));
            Add(new FrontierVisualDefinition("skitter", FrontierKind.Companion, FrontierSkitter.Rig, FrontierSkitter.Build, new FrontierPortrait(-34, 16, .14f), 0, 1, 4));
            Add(new FrontierVisualDefinition("hollow", FrontierKind.Companion, FrontierHollow.Rig, FrontierHollow.Build, new FrontierPortrait(-30, 8, .12f), 0, 1, 4));
            Add(new FrontierVisualDefinition("loam", FrontierKind.Companion, FrontierLoam.Rig, FrontierLoam.Build, new FrontierPortrait(-36, 18, .12f), 0, 1, 5));
