...
status: superseded
folder: 99-archive
superseded-by: bible §1.2, §4.4, §4.7
verified-against: broodline_bible.md (2026-09-05)
note: >
  Era-2. Frame/Armament/Field slots and armor-type traits (Plated Hide, Fused
  Hide). The 'Trait Codex' in bible §4.7 is a UI component, not this document.
---

> **SUPERSEDED.** Do not build from this document. The design lives in
> `00-bible/broodline_bible.md`. Kept for provenance only.
